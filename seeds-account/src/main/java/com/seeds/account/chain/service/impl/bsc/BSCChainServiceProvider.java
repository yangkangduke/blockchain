...
//import com.seeds.account.dto.ChainOraclePricesDto;
...
//@Slf4j
//@Data
//public class BSCChainServiceProvider extends ChainBasicService implements ChainService {
//
//    /**
//     * 定义当前Chain
//     */
...
//                throw new AddressBalanceNotSufficientException(String.format("kUSD vault contract balance not sufficient to burn %s, chain %s, need to transfer %s",
//                        deltaKusd.negate().toPlainString(), chain, deltaKusd.negate().subtract(vaultKusdBalance).toPlainString()));
//            }
//        }
...
//        ChainOraclePricesDto chainOraclePricesDto = getOraclePrices(chain, Stream.of(AccountConstants.MCD, AccountConstants.KINE).collect(Collectors.toSet()));
...
//        log.info("reportKaptain, chain={}, mcdReporterVolatility={}, kineReporterVolatility={}, mcdReporterPeriod={}, kineReporterPeriod={}, " +
//                        "chainMcdPrice={}, mcdPrice={}, chainKinePrice={}, currentKinePrice={}, " +
//                        "mcdVolatilityNotExceed={}, isReportMcd={}, isReportKine={}",
//                chain, mcdReporterVolatility, kineReporterVolatility, mcdReporterPeriod, kineReporterPeriod,
//                chainMcdPrice, mcdPrice, chainKinePrice, currentKinePrice,
//                mcdVolatilityNotExceed, isReportMcd, isReportKine);
//        if (isRetry ||
...
//            List<Utf8String> callSymbols = Arrays.asList(new Utf8String(AccountConstants.KINE), new Utf8String(AccountConstants.XKINE));
...
//                        Arrays.asList(new Address(oracleAddress), new Utf8String(AccountConstants.KINE)));
//        Transaction kineTransaction =
//                Transaction.createEthCallTransaction(null, oracleHelperAddress, kineData);
//        String kineResult = web3.readCli().ethCall(kineTransaction, DefaultBlockParameterName.LATEST).send().getValue();
//        List<Type> kineReturns =
//                FunctionReturnDecoder.decode(kineResult, anchorPriceViewEncoder.getOutputParameters());
//        return ChainAnchorPriceView.createInstance(kineReturns);
//    }
//
//    @Override
...
//
//    /**
//     * BSC current_circulating_supply = total_supply - binanceBridgeContractBalance
//     *
//     * @return
//     * @throws IOException
//     */
...
//        // get binanceBridgeContractBalance
//        String bridgeAddress = systemWalletAddressService.getOne(chain, WalletAddressType.KINE_BRIDGE);
//
//        return kineTotalSupply.subtract(getBalanceByAddress(chain, kineAddress, bridgeAddress, 18));
//    }
//
//    @Override
...
//        ChainContractDto chainContractDto = chainContractService.get(chain.getCode(), "WBNB");
...
//        BigInteger gasPrice = web3.readCli().ethGasPrice().send().getGasPrice();
//        log.info("getCurrentGasPriceOracle, chain={}, response={}", chain, gasPrice);
//        MetricsGaugeUtils.gauge("chainGasPrice", Tags.of("type", "safeGasPrice", "chain", chain.getName()), Double.parseDouble(String.valueOf(unscaleAmountByDecimal(gasPrice, 9))));
//        MetricsGaugeUtils.gauge("chainGasPrice", Tags.of("type", "proposeGasPrice", "chain", chain.getName()), Double.parseDouble(String.valueOf(unscaleAmountByDecimal(gasPrice, 9))));
//        MetricsGaugeUtils.gauge("chainGasPrice", Tags.of("type", "fastGasPrice", "chain", chain.getName()), Double.parseDouble(String.valueOf(unscaleAmountByDecimal(gasPrice, 9))));
//        return ChainGasPriceDto.builder()
//                .chain(chain.getCode())
//                .fastGasPrice(gasPrice.longValue())
//                .proposeGasPrice(gasPrice.longValue())
//                .safeGasPrice(gasPrice.longValue())
//                .build();
//    }
//
//    @Override
