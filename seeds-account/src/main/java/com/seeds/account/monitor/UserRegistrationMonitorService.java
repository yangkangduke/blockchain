...
public class UserRegistrationMonitorService {
    ...
    public void monitor() throws Exception {
        ...
        if (null != respGenericDto.getData()) {
            ...
            MetricsGaugeUtils.gauge("user-registration", Tags.of("registered-users", "total"), data.getTotalRegisteredUsers());
            MetricsGaugeUtils.gauge("user-registration", Tags.of("registered-users", "today"), data.getTodayRegisteredUsers());
        }
