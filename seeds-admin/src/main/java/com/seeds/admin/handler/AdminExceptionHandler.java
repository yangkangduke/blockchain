...
public class AdminExceptionHandler {
    ...
    ResponseEntity<GenericDto<String>> handle(InvalidArgumentsException e) {
        log.error("InvalidArgumentsException:", e);
        return new ResponseEntity<>(
    ...
    public ResponseEntity<GenericDto<String>> handle(BindingException e){
        ...
        return new ResponseEntity<>(
                GenericDto.failure("Internal Error:" + AdminErrorCodeEnum.ERR_500_SYSTEM_BUSY.getDescEn(), HttpStatus.BAD_REQUEST.value()),
