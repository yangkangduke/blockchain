...
public enum GameErrorCodeEnum {
    ...
    ERR_10002_NFT_ITEM_HAVE_BEEN_ASSIGNED(10003, "NFT物品已经被分配", "NFT item have been assigned"),
    ERR_10002_NFT_ITEM_CANNOT_TRANSFER(10004, "NFT物品未分配，无法转移", "NFT item not assigned and cannot transfer"),
    // role
