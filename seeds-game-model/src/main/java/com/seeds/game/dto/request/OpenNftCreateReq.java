...
import com.seeds.admin.dto.request.SysNftCreateReq;
...
@ApiModel(value = "OpenNftCreateReq", description = "系统NFT创建")
public class OpenNftCreateReq extends SysNftCreateReq {
